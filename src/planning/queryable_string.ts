import { QueryableString as IQueryableString } from '../interfaces/interfaces';

export class QueryableString implements IQueryableString {
  private str: string;
  ...
  public endsWith(searchString: string): boolean {
    let reverseString = '';
    const reverseSearchString = searchString
      .split('')
      .reverse()
      .join('');
